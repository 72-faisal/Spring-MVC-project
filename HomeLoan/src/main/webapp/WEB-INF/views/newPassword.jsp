					...
					<form action="newPassword" method="post">
						<div class="contact_left_grid">
							...
							<div class="form-group">
								<label for="email">New Password:</label> <input type="password" id="email"
									name="np" placeholder="Enter New Password" required="">
							</div>
							<div class="form-group">
								<label for="email">Confirm New Password:</label> <input type="password" id="email"
									name="cnpassword" placeholder="Enter Confirm New Password" required="">
							</div>

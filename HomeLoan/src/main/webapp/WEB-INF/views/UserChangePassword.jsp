					...
					<form action="ChangePassword" method="post">
						<div class="contact_left_grid">
							<input type="hidden" class="form-control" name="id"
								value="${user.id}" id="exampleInputEmail1"
								aria-describedby="emailHelp">
								
							<div class="form-group">
								<label for="password">Old Password:</label> <input
									type="password" id="password" name="op" required="">
							</div>
							<div class="form-group">
								<label for="password">New Password:</label> <input
									type="password" id="password" name="np"  required="">
							</div>
							<div class="form-group">
								<label for="password">Confirm New Password:</label> <input
									type="password" id="password" name="cnpassword" required="">
							</div>

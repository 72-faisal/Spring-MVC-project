		...
		<div class="container py-md-4 mt-md-3">
			...
			<div class="inner-sec-w3layouts-agileinfo mt-md-5 pt-5">
				...
				<div class="contact_grid_right mt-5">
					...
					<form action="UploadDocuments3" method="post"
						enctype="multipart/form-data">
						<div id="step3">
							<!-- Step 3: Supporting Documents -->
							<h2>Step 3: Supporting Documents</h2>
							<label for="emp_proof">Employment Proof:</label>
							<input type="file" id="emp_proof" name="emp_proof" required>
							
							<label for="property_documents">Property Documents:</label>
							<input type="file" id="property_documents" name="property_documents" required>
							
							<label for="bank_statment">Bank Statement:</label>
							<input type="file" id="bank_statment" name="bank_statment" required>
							
							<label for="dp_proof">Down Payment Proof:</label>
							<input type="file" id="dp_proof" name="dp_proof" required>
							
							<label for="guarantor_document">Guarantor Document:</label>
							<input type="file" id="guarantor_document" name="guarantor_document" required>
							
							<label for="property_valuation_proof">Property Valuation Proof:</label>
							<input type="file" id="property_valuation_proof" name="property_valuation_proof" required>
							
							<label for="property_insurance">Property Insurance:</label> 
							<input type="file" id="property_insurance" name="property_insurance" required>

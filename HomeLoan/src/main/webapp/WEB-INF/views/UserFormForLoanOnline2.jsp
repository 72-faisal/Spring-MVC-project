...
/* Style for each step/page */
#step1, #step2, #step3 {
	display: none;
}

/* Common styling for steps */
...
<body>
		...
		<div class="container py-md-4 mt-md-3">
			...
			<div class="inner-sec-w3layouts-agileinfo mt-md-5 pt-5">
				...
				<div class="contact_grid_right mt-5">
					...
					<form action="UploadDocuments2" method="post" enctype="multipart/form-data" id="multiStepForm">
						
						<div id="step2">
						
							<h2>Step 2: Property Information</h2>
							<input type="hidden" name="currentStep" id="currentStep" value="2">
							<label for="poidentity">Proof of Identity:</label>
							<input type="file" id="poidentity" name="poidentity"	required>
						    <label for="poresidence">Proof of Residence:</label>
						    <input type="file" id="poresidence"	name="poresidence" required>
						    <label for="poincome">Proof of Income:</label>
						    <input type="file" id="poincome" name="poincome" required>
    ...
    function nextStep() {
        ...
        // Submit the form to the next JSP file (step3.jsp)
        document.getElementById('multiStepForm').action = 'UserFormForLoanOnline3';

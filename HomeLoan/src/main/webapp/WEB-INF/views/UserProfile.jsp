			...
			<div class="inner-sec-w3layouts-agileinfo mt-md-5 pt-5">
				...
				<div class="contact_grid_right mt-5">
					...
					<form action="UpdateProfile/${user.id}" method="post">
						...
						<input type="hidden" class="form-control" name="id" value="${user.id}" id="exampleInputEmail1" aria-describedby="emailHelp">
							...
							<div class="form-group">
								<label for="contact">Contact:</label> <input type="text"
									...
									placeholder="Enter your contact number" value="${user.contact }">
							</div>
							<div class="form-group">
							<label for="contact">Gender:</label>
								<input type="text" id="contact" name="gender"
									placeholder="Your contact number" value="${user.gender }">
							</div>
							<div class="form-group">
								<label for="email">Email:</label> <input type="email" id="email"
									name="email" placeholder="Your email" value="${user.email }">
							</div>
						...
						<!-- 	<div class="form-group">
							...
							<br>
							<!-- <h3>
								Not Registered Yet? <a href="UserRegister">Click here</a> to
								Register
							</h3> -->
						</div>
					</form>

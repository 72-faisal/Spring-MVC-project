				...
				<div class="contact_grid_right mt-5">
					...
					<form action="OTPVerification" method="post">
						<div class="contact_left_grid">
							...
							%>
							<%
							int otp = (Integer) request.getAttribute("otp1");
							%>
							<input type="hidden" id="email" name="email" value="${email}">
							<input type="hidden" id="otp1" name="otp" value="${otp}">
							<div class="form-group">
								<label for="email">Enter OTP (from email):</label> <input
									type="text" id="email" name="otp2" required="">
							</div>

				...
				<div class="contact_grid_right mt-5">
					...
					<form action="LoginUser" method="post">
						<div class="contact_left_grid">
							...
							<input type="text" name="address" placeholder="Name" required="">
							<input type="text" name="gender" placeholder="Name" required="">
							<input type="number" name="contact" placeholder="Name" required=""> -->
							...
							<br> <a href="ForgetPassword">Forget Password</a>
						</div>
					</form>
				</div>
			</div>

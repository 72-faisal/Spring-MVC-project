			...
			<div class="row about-tp mt-md-5 pt-5">
				...
				<div class="col-lg-6 welcome-right">
					<div class="welcome-right-top">
						<img src="<%= request.getContextPath() %>/resources/images/g1.jpg" alt="" class="img-fluid">
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row team-row-agileinfo mt-md-5 pt-5">
				<div class="col-lg-3 col-md-6 col-sm-6 team-grids">
					<div class="thumbnail team-agileits">
						<img src="<%= request.getContextPath() %>/resources/images/te1.jpg" class="img-fluid" alt="" />
				...
				<div class="col-lg-3 col-md-6 col-sm-6 team-grids">
					<div class="thumbnail team-agileits">
						<img src="<%= request.getContextPath() %>/resources/images/te2.jpg" class="img-fluid" alt="" />
						<div class="effectd-caption">
				...
				<div class="col-lg-3 col-md-6 col-sm-6 team-grids">
					<div class="thumbnail team-agileits">
						<img src="<%= request.getContextPath() %>/resources/images/te3.jpg" class="img-fluid" alt="" />
						<div class="effectd-caption">
				...
				<div class="col-lg-3 col-md-6 col-sm-6 team-grids">
					<div class="thumbnail team-agileits">
						<img src="<%= request.getContextPath() %>/resources/images/te4.jpg" class="img-fluid" alt="" />
						<div class="effectd-caption">

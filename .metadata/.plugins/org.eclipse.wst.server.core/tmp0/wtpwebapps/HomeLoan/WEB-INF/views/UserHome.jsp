...
SmartPhone Compatible web template, free WebDesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<!-- font-awesome icons -->
	<link href="<%= request.getContextPath() %>/resources/css/fontawesome-all.min.css" rel="stylesheet">
	<!-- //Custom Theme files -->
	<!-- online fonts -->
	<!-- titles -->
	...
	<div class="top">
		...
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light">
				<h1>
					<a class="navbar-brand text-capitalize" href="index">
						Home Loan
					</a>
				</h1>
					...
					<ul class="navbar-nav text-center  ml-lg-auto">
						...
						<li class="nav-item dropdown mr-3">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								...
								<a class="dropdown-item" href="LoanApprovedProject">Approved Project</a>
								<a class="dropdown-item" href="LoanCalculator">Loan Calculator</a>
							</div>
						</li>
						<li class="nav-item dropdown mr-3">
							<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true"
				...
				<li>
					<div class="slider-info bg1">
						<div class="banner-text container">
							...
							<a class="bt text-capitalize" href="about" role="button"> read more
	...
	<section class="details-books py-5">
		...
		<h2 class="heading-agileinfo">Fast & Easy Application Process<span>Speed Up the Loan Process</span></h2>
			...
			<div class="col-lg-6 details-w3l">
				<img src="<%= request.getContextPath() %>/resources/images/g4.jpg" class="img-fluid" alt="" />
			</div>
			</div>
		</div>
	</section>
					...
					<div class="stats1">
						<div class="row stats_inner">
							<div class="col-md-6 col-sm-6 col-xs-6 stat-grids">
								<img src="<%= request.getContextPath() %>/resources/images/logo1.jpg" alt="logo1" class=" img-fluid">
							</div>
							<div class="col-md-6 col-sm-6 col-xs-6 stat-grids">
								<img src="<%= request.getContextPath() %>/resources/images/logo2.jpg" alt="logo1" class=" img-fluid">
							</div>
						</div>
						<div class="row stats_inner top-st">
							<div class="col-md-6 col-sm-6 col-xs-6 stat-grids">
								<img src="<%= request.getContextPath() %>/resources/images/logo3.jpg" alt="logo1" class=" img-fluid">
							</div>
							<div class="col-md-6 col-sm-6 col-xs-6 stat-grids">
								<img src="<%= request.getContextPath() %>/resources/images/logo1.jpg" alt="logo1" class=" img-fluid">
							</div>
									...
									<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
										  ...
										  <div class="carousel-inner">
											<div class="carousel-item active">
												<div class="row thumbnail adjust1">
													 <div class="col-md-3 col-sm-3">
														  <img class="media-object img-fluid" src="<%= request.getContextPath() %>/resources/images/ts1.jpg" alt="" />
													   </div>
											...
											<div class="carousel-item">
												<div class="row thumbnail adjust1">
													 <div class="col-md-3 col-sm-3">
														  <img class="media-object img-fluid" src="<%= request.getContextPath() %>/resources/images/ts2.jpg" alt="" />
													   </div>
													   <div class="col-md-9 col-sm-9">
															<div class="caption testi-text">
																  <h4>Jane Wilson</h4>
											...
											<div class="carousel-item">
												<div class="row thumbnail adjust1">
													 <div class="col-md-3 col-sm-3">
														  <img class="media-object img-fluid" src="<%= request.getContextPath() %>/resources/images/ts3.jpg" alt="" />
													   </div>
													   <div class="col-md-9 col-sm-9">
															<div class="caption testi-text">
																  <h4>Jane Wilson</h4>
	...
	<section class="wthree-row w3-about py-5">
		<div class="container py-md-4 mt-md-3">
			...
			<div class="card-deck mt-md-5 pt-5">
				  <div class="card">
					<img src="<%= request.getContextPath() %>/resources/images/g7.jpg" class="img-fluid" alt="Card image cap">
				  ...
				  <div class="card">
					<img src="<%= request.getContextPath() %>/resources/images/g6.jpg" class="img-fluid" alt="Card image cap">
					<div class="card-body w3ls-card">
				  ...
				  <div class="card">
					<img src="<%= request.getContextPath() %>/resources/images/g8.jpg" class="img-fluid" alt="Card image cap">
					<div class="card-body w3ls-card">
					...
					<div class="footer-list">
						<div class="flickr-grid">
							<a href="#" data-toggle="modal" data-target="#myModal">
								<img src="<%= request.getContextPath() %>/resources/images/g1.jpg" class="img-fluid" alt=" ">
							</a>
						</div>
						<div class="flickr-grid">
							<a href="#" data-toggle="modal" data-target="#myModal">
								<img src="<%= request.getContextPath() %>/resources/images/g2.jpg" class="img-fluid" alt=" ">
							</a>
						</div>
						<div class="flickr-grid">
							<a href="#" data-toggle="modal" data-target="#myModal">
								<img src="<%= request.getContextPath() %>/resources/images/g3.jpg" class="img-fluid" alt=" ">
							</a>
						</div>
						<div class="flickr-grid">
							<a href="#" data-toggle="modal" data-target="#myModal">
						...
						<div class="flickr-grid">
							<a href="#" data-toggle="modal" data-target="#myModal">
								<img src="<%= request.getContextPath() %>/resources/images/g5.jpg" class="img-fluid" alt=" ">
							</a>
						</div>
						<div class="flickr-grid">
							<a href="#" data-toggle="modal" data-target="#myModal">
								<img src="<%= request.getContextPath() %>/resources/images/g6.jpg" class="img-fluid" alt=" ">
							</a>
						</div>
						<div class="flickr-grid">
							<a href="#" data-toggle="modal" data-target="#myModal">
								<img src="<%= request.getContextPath() %>/resources/images/g7.jpg" class="img-fluid" alt=" ">
							</a>
						</div>
						<div class="flickr-grid">
							<a href="#" data-toggle="modal" data-target="#myModal">
								<img src="<%= request.getContextPath() %>/resources/images/g9.jpg" class="img-fluid" alt=" ">
							</a>
						</div>
						<div class="flickr-grid">
							<a href="#" data-toggle="modal" data-target="#myModal">
								<img src="<%= request.getContextPath() %>/resources/images/g8.jpg" class="img-fluid" alt=" ">
							</a>
						</div>
...
<!-- stats -->
	...
	<script src="<%= request.getContextPath() %>/resources/js/jquery.countup.js"></script>
		<script>
			$('.counter').countUp();
		</script>
<!-- //stats -->

...
<body>
				...
				<div class="contact_grid_right mt-5">
					...
					<form action="UploadDocuments" method="post"
						...
						<div id="1">
							...
							<input type="text" id="lemail" name="lemail" required> 
							
							<label for="laddress">Address:</label>
							<input type="text" id="laddress" name="laddress" required>
							
							<label for="lcontact">Contact Number:</label>
							<input type="text" id="lcontact" name="lcontact" required>
	...
	<script>
		function nextStep() {
			...
			// Submit the form to the next JSP file (step2.jsp)
			document.getElementById('multiStepForm').action = 'UserFormForLoanOnline2';

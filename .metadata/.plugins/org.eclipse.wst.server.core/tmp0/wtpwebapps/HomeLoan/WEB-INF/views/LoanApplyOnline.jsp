...
<body>
	...
	<div
		...
		<h2>
			<span>Instant e-approval in 3 simple steps</span>
		</h2>
		<h3>${cust.msg }</h3>
		<ul>
			<li>
				<p>
					<img
						src="<%=request.getContextPath()%>/resources/images/apply-img1.png"
						alt="Property Details" title="Property Details">
				</p>
				<p>
					Fill Income &amp; <br>Property Details
				</p>
			</li>
			<li>
				<p>
					<img
						src="<%=request.getContextPath()%>/resources/images/apply-img2.png"
						alt="View &amp; Apply for Loan offers"
						title="View &amp; Apply for Loan offers">
				</p>
				<p>
					View &amp; Apply <br>for Loan offers
				</p>
			</li>
			<li>
				<p>
					<img
						src="<%=request.getContextPath()%>/resources/images/apply-img3.png"
						alt="Complete your Application" title="Complete your Application">
				</p>
				<p>
			...
			<li>
				<p>
					<img
						src="<%=request.getContextPath()%>/resources/images/apply-img4.png"
						alt="Instant Approval" title="Instant Approval">
				</p>
				<p>
					Instant <br>Approval
				</p>
		...
		<p class="txt-center" style="text-align: center;">
			<a Href=UserFormForLoan></a><input type="submit" class="apply-btn" value="Apply Now">>
					</p>
	</div>
</form>
	<!--footer-->
